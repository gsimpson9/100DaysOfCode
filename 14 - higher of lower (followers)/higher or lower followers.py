...
#pull out 2 strings out of the list of dictionaries
...
while game_on:
    ...
    #if guess is correct +1 to score if not game ends and produces score
    compare_result = compare(user_guess, celeb_a_followers, celeb_b_followers)
    ...
    #each guess they get correct remove A from the list and B becomes A
